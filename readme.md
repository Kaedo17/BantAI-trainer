...
### "Found 0 images with labels" during split
- **Issue**: Labels not found in expected location
- **Fix**: Check that your dataset has `images/train` and `labels/train` folders
...
### What does the "back" and "cancel" options do?
- `back`: Returns to the previous menu
- `cancel`: Exits the current operation

### Why are my class names showing as numbers?
The pipeline preserves class names from your original `data.yaml`. Make sure your original dataset has proper class names.
